...
def test_color2gray(image):
    ...
    gray_image = numba_color2gray(pixels)
    ...
    print('Yay! All unit tests passed for c2g filter function implemented with numba')
...
def test_color2sepia(image):
    ...
    print('Yay! All unit tests passed for c2s filter function implemented with numba')
